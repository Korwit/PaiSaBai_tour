...
const Addtour = () => {
    ...
    const handleShowModal = async () => {
        const result = await axios.get('/trip-dates?populate[0]=tour&filters[tour][name][$null]=*')
            ...
            <Form onSubmit={handleSubmit} className="custom-Form">
                    ...
                    <Form.Group>
                        <div className="password-input3">
                            ...
                            <Form.Control
                                ...
                                required value={topic} style={{ width: '400px' }}
                ...
                <Form.Group controlId="imgfile">
                    ...
                    {files && files.length > 0 &&
                        <img src={URL.createObjectURL(files[0])} width={"100px"} alt="Selected" />
                    }
                </Form.Group>
                ...
                <span className='logintext'>วันไปและวันกลับ<a href="#" onClick={handleShowModal} class="link" >เพิ่มหรือแก้ไข</a></span>
            ...
            <Modal show={showModal} onHide={handleCloseModal}>
                ...
                <Modal.Body>
                    <Row>
                        <Col>
                            <form>
                                ...
                                {eff && (
                                    <div className="alert alert-danger" role="alert">{eff}</div>
                                )}
                            </form>
                        </Col>
                        <Col>
                            <form>
                                ...
                                <input type="date" id="dates" name="dates" onChange={DayReturn} />
                                {eff && (
                                    <div className="alert alert-danger" role="alert">{eff}</div>
                                )}
                            </form>
                    ...
                    {daydata.map((item, index) => (
                        <div key={index}>
                            <h6>วันไป: {item?.attributes?.go_date} วันกลับ: {item?.attributes?.end_date}</h6>
